...
export function handleBlock(block: ethereum.Block): void {
  ...
  looksReward.apr = BigDecimal.fromString(totalLooksRewardsPerYear.toString()).div(BigDecimal.fromString(reward.totalLooksStaked.toString()))
  log.debug("totalLooksStaked: {}, looksRewardsPerBlock: {}, apr: {}", [reward.totalLooksStaked.toString(), looksReward.looksRewardsPerBlock.toString(), looksReward.apr.toString()])
  looksReward.save()
