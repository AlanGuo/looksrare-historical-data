...
export class FeeSharingSystem extends ethereum.SmartContract {
  ...
  calculateSharePriceInLOOKS(): BigInt {
    let result = super.call(
  ...
  try_calculateSharePriceInLOOKS(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "calculateSharePriceInLOOKS",
      "calculateSharePriceInLOOKS():(uint256)",
      []
  ...
  calculateSharesValueInLOOKS(user: Address): BigInt {
    let result = super.call(
      "calculateSharesValueInLOOKS",
      "calculateSharesValueInLOOKS(address):(uint256)",
      [ethereum.Value.fromAddress(user)]
    );
  ...
  try_calculateSharesValueInLOOKS(user: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "calculateSharesValueInLOOKS",
      "calculateSharesValueInLOOKS(address):(uint256)",
      [ethereum.Value.fromAddress(user)]
  ...
  try_tokenDistributor(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "tokenDistributor",
      "tokenDistributor():(address)",
      []
