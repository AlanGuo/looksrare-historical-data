...
export class UniswapLooksWeth__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapLooksWeth__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UniswapLooksWeth extends ethereum.SmartContract {
  static bind(address: Address): UniswapLooksWeth {
    return new UniswapLooksWeth("UniswapLooksWeth", address);
  }
  ...
  burn(to: Address): UniswapLooksWeth__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new UniswapLooksWeth__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<UniswapLooksWeth__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UniswapLooksWeth__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): UniswapLooksWeth__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new UniswapLooksWeth__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<UniswapLooksWeth__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapLooksWeth__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
